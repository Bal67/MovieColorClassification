...
# Assuming you have a function to get predictions from your CNN model
def get_cnn_model_predictions(image_folder):
    predictions = []
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = "/content/drive/My Drive/MovieGenre/MovieGenreClassification/data/processed/cnn_model_predictions.json"
    predictions = get_cnn_model_predictions(IMAGE_FOLDER)
