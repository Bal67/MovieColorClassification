...
def prepare_data(missing_value_strategy="remove", default_genre="Unknown"):
    """
    ...
    if num_missing > 0:
        print(f"Removed {num_missing} entries due to missing images.")

    return images, labels

# Example usage with "remove" strategy (default)
images, labels = prepare_data()

# Or, example usage with "default" strategy
